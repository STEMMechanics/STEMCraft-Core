...
public class SMXPCalculator {
     ...
     */
    public SMXPCalculator(Player player) {
        if(player != null) {
            this.player = player;
        }
    }
    ...
    public static void setHardMaxLevel(int hardMaxLevel) {
        SMXPCalculator.hardMaxLevel = hardMaxLevel;
    }
    ...
    public int getCurrentExp() {
        ...
        int cur = getXpForLevel(lvl) + Math.round(getXpNeededToLevelUp(lvl) * this.player.getExp());
        return cur;
    }
    ...
    private double getCurrentFractionalXP() {
        ...
        int lvl = this.player.getLevel();
        double cur = getXpForLevel(lvl) + (double) (getXpNeededToLevelUp(lvl) * this.player.getExp());
        return cur;
    }
